...
import { articlesList, categoriesList } from "./data_articles";
...
export const defaultContentProducts = {
  ...
  arabic: {
    short_description:
      "تسعى Pigeon جاهدة لتقديم الحلول الشاملة لجميع متطلباتك كأم. نمتلك كل ما قد تحتاجينه من منتجات العناية بالطفل واحتياجات الأمومة. تخضع منتجاتنا لفحوصات الجودة الشاملة وهي مصنوعة من مواد بلاستيكية وأقمشة عالية الجودة. تم إعداد كل منتجاتنا جيدا من خلال بحوث مستفيضة لتكون أكثر طبيعية. نقدم العديد من المنتجات التي يمكنك الاختيار من بينها، بدءا من مستلزمات الرضاعة الطبيعية، ومنتجات الرعاية الصحية، وتغذية الأطفال، إلى مستلزمات النظافة وكل ما تحتاجينة للفطام.",
    long_description:
      "الهدف الأساسي الذي تم إنشاء Pigeon من أجله هو تقديم أفضل المنتجات الملائمة والمريحة ذات الأسعار المعقولة. مع وجود مجموعة كبيرة ومتنوعة من المنتجات من فئات مختلفة، تمتلك Pigeon أفضل منتجات العناية بالأطفال والأمهات التي يمكنك الاختيار من بينها. تقوم Pigeon بتصنيع أفضل منتجات الأطفال منذ عقود وحتى الآن، حيث تسعى دائما إلى ابتكار منتجات رائعة وسهلة الاستخدام. تخضع منتجاتنا لسلسلة من فحوصات الجودة الصارمة لضمان حصول طفلك على أفضل المنتجات.",
    message: "تهتم Pigeon بالاعتناء بطفلك تمام كإهتمام الأم بطفلها!",
    videoTitle: "نحتفل بالأطفال على طبيعتهم ‎",
    video_description:
      "<h3>نحتفل بالأطفال على طبيعتهم</h3><p>تجلب بيجون الفرح والسعادة والإلهام للأطفال والعائلات في جميع أنحاء العالم عبر تزويدهم بالمنتجات والخدمات التي تجسد الحب.</p>‎",
    name: "منتجاتنا",
  },
  short_description:
  ...
  message: "Pigeon cares for your baby as only a mother would know how!",
...
export const videoGrid = [
  ...
  },
  {
    ...
    title: "3D computer graphic of latch-on(English)2016.8ver",
  },
];
...
export const FAQs = [
  ...
  {
    question: "My hair is falling out. What can be the reason?",
  ...
  {
    question: "I am scared of labor. It seems painful and long. What to do?",
  ...
  {
    question: "Why is it better to give my newborn baby breast milk?",
  ...
  {
    question: "When can I start tossing my baby in the air?",
  ...
  {
    question: "My baby always follows me everywhere. At what age will he stop?",
    answer: `
  ...
  {
    question: "My baby puts everything in his mouth. How to make him stop?",
    answer: `
